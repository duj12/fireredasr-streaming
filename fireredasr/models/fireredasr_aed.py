...
from fireredasr.models.conformer_encoder import ConformerEncoder
from fireredasr.models.transformer_decoder import TransformerDecoder
...
class FireRedAsrAed(torch.nn.Module):
    ...
    def transcribe(self, padded_input, input_lengths,
        ...
        nbest_hyps = self.decoder.batch_beam_search(
            ...
            softmax_smoothing, length_penalty, eos_penalty, ys_state)
        return nbest_hyps
